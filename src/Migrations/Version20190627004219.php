 ...
 */
final class Version20190627004219 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE asset (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, label VARCHAR(255) NOT NULL, currency VARCHAR(255) NOT NULL COMMENT \'(DC2Type:userCurrencyCodes)\', value DOUBLE PRECISION UNSIGNED NOT NULL, INDEX IDX_2AF5A5CA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
